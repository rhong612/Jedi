...
object WookieParsers {
	def test = {
    println("------------TESTING NUMBER PARSER----------------")
    val wookieParser = new WookieParsers
    var expression = "+10"
    var tree = wookieParser.parseAll(wookieParser.number, expression)
    println("Expected: 10")
    println("Actual: " + tree.get)
    expression = "-10"
    tree = wookieParser.parseAll(wookieParser.number, expression)
    ...
    expression = "true"
    var bTree = wookieParser.parseAll(wookieParser.boole, expression)
    println("Expected: " + expression)
    println("Actual: " + bTree.get)
    expression = "false"
    bTree = wookieParser.parseAll(wookieParser.boole, expression)
    println("Expected: " + expression)
    println("Actual: " + bTree.get)
    ...
    expression = "aVarName"
    var iTree = wookieParser.parseAll(wookieParser.identifier, expression)
    println("Expected: " + expression)
    println("Actual: " + iTree.get)
    expression = "withNumbers01231"
    iTree = wookieParser.parseAll(wookieParser.identifier, expression)
    println("Expected: " + expression)
    println("Actual: " + iTree.get)
    ...
    expression = "true"
    var lTree = wookieParser.parseAll(wookieParser.literal, expression)
    println("Expected: " + expression)
    println("Actual: " + lTree.get)
    expression = "4.5124"
    lTree = wookieParser.parseAll(wookieParser.literal, expression)
    println("Expected: " + expression)
    println("Actual: " + lTree.get)
    ...
    expression = "3 + 4 * 5"
    var eTree = wookieParser.parseAll(wookieParser.expression, expression)
    println()
    println(expression)
    println("Expected: " + 23)
